...
namespace DP.Chess.MAUI.Features.Chess.Boards
{
    ...
    public class ChessBoardFactory : IBoardFactory
    {
        ...
        public ChessBoardFactory(IChessBoardMovementService movementService)
        {
        ...
        {
            ChessBoardViewModel vm = new(_movementService, CreateChessBoardCells(), PlayerColor.White);
